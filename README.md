...
| [docs/research/astral-self-modeling/136-trace-completeness-gemma3-causal-feature-effects-v2-failure-postmortem-2026-09-02.md](docs/research/astral-self-modeling/136-trace-completeness-gemma3-causal-feature-effects-v2-failure-postmortem-2026-09-02.md) | Aggregate-only V2 failure decomposition: feature 832 lost tune support, repeated-row prediction was below threshold, raw deletion limits mechanism attribution, and a new bundle theory is explicitly separated from V2 repair. |
| [docs/research/astral-self-modeling/137-trace-completeness-gemma3-causal-feature-bundle-effects-v3-protocol.md](docs/research/astral-self-modeling/137-trace-completeness-gemma3-causal-feature-bundle-effects-v3-protocol.md) | Fresh V3 jointly causal bundle protocol with family-level estimands, exact interchange operators, locked seven-term abstraction, held-out scrubbing, external custody, and independent-ACCEPT/node gates. |
