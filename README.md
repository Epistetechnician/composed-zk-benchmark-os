...
| [docs/664-phase-hsai-gateway-proposal-preimage-lean-local-kernel-check.md](docs/664-phase-hsai-gateway-proposal-preimage-lean-local-kernel-check.md) | Phase 664 HSAI gateway proposal preimage Lean local kernel check: committed checksum-bound Darwin arm64 Lean 4.30.0 acquisition and exact theorem-run authorization, currently `NotRun` and `Level1LocalReplayOrLower`. |
