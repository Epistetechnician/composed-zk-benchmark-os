...
| [docs/779-phase-hsai-formal-source-ledger-expansion.md](docs/779-phase-hsai-formal-source-ledger-expansion.md) | Phase 779 HSAI source-ledger expansion: 102 field-complete JSONL rows with exact order, capabilities, transcript paths, and typed blockers; all rows remain blocked and no ledger digest exists. |
