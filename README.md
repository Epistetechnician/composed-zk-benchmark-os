...
| [docs/665-phase-hsai-gateway-proposal-preimage-lean-model-checker-witness.md](docs/665-phase-hsai-gateway-proposal-preimage-lean-model-checker-witness.md) | Phase 665 HSAI gateway proposal preimage Lean model-checker witness: `NotRun` authorization for two shared concrete preimage fixtures, one test-only Rust binding, and one Lean `by decide` witness theorem; no production/checker/Cargo changes, accepted evidence, Level2+, score axes, source-correspondence proof, or claim promotion. |
