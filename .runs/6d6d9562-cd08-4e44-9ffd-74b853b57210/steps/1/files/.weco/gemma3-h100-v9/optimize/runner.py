...
def run(model_root: Path, raw_root: Path, source_root: Path, corpus_root: Path, result_root: Path, launch_manifest: Path, repo_root: Path | None = None, tokenizer: Any | None = None) -> dict[str, Any]:
    ...
    result = {
        ...
        "hard_usd_ceiling": "{:.2f}".format(launch["hard_usd_ceiling"]),
        "estimated_max_total_usd": "{:.2f}".format(launch["estimated_max_total_usd"]),
        ...
        "provider_charged_usd": "{:.2f}".format(provider_receipt["charged_usd"]),
