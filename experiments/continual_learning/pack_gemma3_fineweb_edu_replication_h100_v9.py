...
SOURCE_SCHEMA = "gemma3-fineweb-edu-replication-h100-v9-source"
...
EXCLUSION_RANGES = (
    ...
    ("prior-h100-v3", 51_200, 67_584), ("prior-h100-v4", 67_584, 83_968),
...
def validate_source_bundle(raw_root: Path, source_root: Path) -> tuple[dict[str, Any], dict[str, list[dict[str, Any]]]]:
    ...
    expected_keys = {
        ...
        "excluded_protocol_identities", "excluded_protocol_boundaries",
    ...
    if (
        ...
        or manifest["excluded_protocol_identities"] != [
            f"prior-h100-{identity}" for identity in EXCLUDED_PROTOCOL_IDENTITIES
        ]
        or manifest["excluded_protocol_boundaries"] != [
            {"identity": identity, "start": start, "end_exclusive": end}
            for identity, start, end in EXCLUDED_PROTOCOL_BOUNDARIES
        ]
