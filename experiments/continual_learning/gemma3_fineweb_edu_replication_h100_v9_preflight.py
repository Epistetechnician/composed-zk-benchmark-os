...
def validate_launch_manifest(
    ...
    ceiling = parse_usd_canonical(manifest["hard_usd_ceiling"], "hard_usd_ceiling")
    rate = parse_usd_canonical(manifest["quoted_gpu_usd_per_minute"], "quoted_gpu_usd_per_minute")
    minutes = finite_positive(manifest["max_runtime_minutes"], "max_runtime_minutes")
    estimate = parse_usd_canonical(manifest["estimated_max_total_usd"], "estimated_max_total_usd")
