...
SOURCE_MANIFEST_PATH = Path("/Users/shaanp/Documents/research-artifacts/continual-learning-minimind-three-lane-sota-v2-source-manifest-20260903.json")
CORPUS_ROOT = Path("/Users/shaanp/Documents/research-artifacts/continual-learning-minimind-three-lane-sota-v2-corpus-20260903")
CORPUS_MANIFEST_PATH = CORPUS_ROOT / "corpus-manifest.json"
SOURCE_ROOT = Path("/Users/shaanp/Documents/research-artifacts/continual-learning-minimind-three-lane-sota-v2-source-20260903")
SYNTHETIC_ROOT = Path("/Users/shaanp/Documents/research-artifacts/continual-learning-minimind-three-lane-sota-v2-synthetic-20260903")
MODEL_ROOT = Path("/Users/shaanp/Documents/research-artifacts/continual-learning-minimind-three-lane-sota-v2-model-20260903")
...
RECEIPT_PATH = Path("/Users/shaanp/Documents/research-artifacts/continual-learning-minimind-three-lane-sota-v2-execution-receipt-20260903.json")
...
MODEL_REPLICATE_SEEDS = (2026090301,)
...
def _source_manifest(source_root: Path) -> dict[str, Any]:
    ...
    manifest = {"schema_version": "minimind-three-lane-source-manifest-v2", "state_slice": STATE_SLICE, "url": UPSTREAM_URL, "commit": commit, "remote": remote, "license": "Apache-2.0", "checkout": str(source_root), "required_files": files}
...
def _load_corpus_manifest(path: Path) -> dict[str, Any]:
    ...
    _require(set(manifest) == expected and manifest["schema_version"] == "minimind-three-lane-corpus-manifest-v2" and manifest["state_slice"] == STATE_SLICE, "corpus manifest schema mismatch")
...
def _load_trust_bundle() -> dict[str, Any]:
    ...
    _require(set(bundle) == required and bundle["schema_version"] == "minimind-three-lane-sota-trust-bundle-v2" and bundle["state_slice"] == STATE_SLICE and bundle["source"] == "external-read-only-authority", "trust bundle schema or identity mismatch")
...
def write_synthetic(output: Path) -> dict[str, Any]:
    ...
    source = {"schema_version": "minimind-three-lane-source-manifest-v2", "state_slice": STATE_SLICE, "kind": "deterministic-fixture", "manifest_sha256": _digest({"schema_version": "minimind-three-lane-source-manifest-v2", "state_slice": STATE_SLICE, "kind": "deterministic-fixture"})}
