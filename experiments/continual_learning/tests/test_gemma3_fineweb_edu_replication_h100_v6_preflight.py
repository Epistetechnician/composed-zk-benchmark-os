...
def _manifest() -> dict[str, object]:
    values: dict[str, object] = {
        ...
        "provider_attestation_key_id": "gman-test-key-v6",
        "provider_trust_root_id": "gman-test-root-v6",
        ...
        "runner_entrypoint": "run_h100_v6.sh",
        "runtime_lock_path": "runtime-lock.json",
        "runtime_lock_sha256": "2" * 64,
        "network_lock": "network-none-v6",
        ...
        "external_storage_namespace": "bucket/namespace-v6",
        "review_receipt_path": "review.json",
        "review_receipt_sha256": "e" * 64,
        "protocol_sha256": "f" * 64,
        "packet_sha256": "0" * 64,
        "launch_command": "./run_h100_v6.sh",
        "launch_command_sha256": hashlib.sha256(b"./run_h100_v6.sh").hexdigest(),
