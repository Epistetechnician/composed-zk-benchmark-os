...
from experiments.continual_learning import (
    gemma3_fineweb_edu_replication_h100_v3 as runner,
)
from experiments.continual_learning import (
    validate_gemma3_fineweb_edu_replication_h100_v3 as validator,
)
...
def test_provider_bundle_has_no_runtime_install_or_provider_submission() -> None:
    root = Path(__file__).parents[1] / "gemma3_fineweb_edu_replication_h100_v3_provider"
    dockerfile = (root / "Dockerfile").read_text(encoding="utf-8")
    entrypoint = (root / "run_h100_v3.sh").read_text(encoding="utf-8")
    ...
    assert "network-none-v3" in entrypoint
    ...
    assert "pack_gemma3_fineweb_edu_replication_h100_v3.py" in dockerfile
