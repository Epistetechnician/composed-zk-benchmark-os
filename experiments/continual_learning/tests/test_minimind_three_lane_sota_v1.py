"""Hermetic tests for state slice continual-learning-minimind-three-lane-sota-v1."""
...
from experiments.continual_learning import minimind_three_lane_sota_v1 as harness
