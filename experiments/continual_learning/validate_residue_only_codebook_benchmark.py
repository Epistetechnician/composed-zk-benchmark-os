#!/usr/bin/env python3
"""Independent validator for the V11 residue-only codebook preflight."""
...
from experiments.continual_learning.validate_compositional_model_benchmark import LABELS  # noqa: E402
...
def model_accuracy(model, facts) -> dict:
    ...
    for fact in facts:
        ...
        correct += int(hit)
        rows.append({"fact_id": fact["fact_id"], "expected": fact["label"], "observed": prediction, "correct": hit})
