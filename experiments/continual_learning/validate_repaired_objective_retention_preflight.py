#!/usr/bin/env python3
"""Independent validator for the V14 repaired-objective retention preflight."""
...
def validate(root: Path) -> dict:
    ...
    if result["retention_comparison_run"] is not True:
        raise ValueError("retention comparison was not recorded")
    fixed = {
    ...
    if result["tasks"] != tasks or len(tasks) != 4:
