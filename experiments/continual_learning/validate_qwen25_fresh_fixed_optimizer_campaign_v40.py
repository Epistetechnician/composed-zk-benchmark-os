#!/usr/bin/env python3
"""Independent campaign validator for V40 fresh-task acquisition receipts."""
...
from experiments.continual_learning.validate_qwen25_fresh_fixed_optimizer_acquisition_v40 import validate as validate_case
...
def validate(root: Path) -> dict:
    ...
    if contract["optimizer_seed_base"] != FIXED_OPTIMIZER_SEED or contract["order"] != list(ORDER):
        raise ValueError("campaign optimizer/order drift")
    ...
    if report["independence_status"] != "fresh_task_seed_campaign_under_frozen_repair_policy":
