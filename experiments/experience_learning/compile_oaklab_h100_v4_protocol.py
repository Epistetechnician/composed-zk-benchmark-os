#!/usr/bin/env python3
"""Compile the Oak Lab H100 replication V4 protocol.
...
COMPILER_VERSION = "oaklab.h100.v4.protocol-compiler.v1"
SECTIONS = (
...
SOURCE_PATH = Path("experiments/experience_learning/oaklab_h100_v4_protocol.json")
COMPILED_PATH = Path("experiments/experience_learning/oaklab_h100_v4_compiled_protocol.json")
FREEZE_FILES = (
    str(SOURCE_PATH),
...
def validate_source(source: dict[str, Any]) -> None:
    ...
    expected = {"sparse_signal_v4", "drifting_relevance_v4", "delayed_reward_v4", "event_sensor_v4", "long_horizon_v4", "pure_noise_v4"}
    ...
    required_schema_names = {"fit_lock", "tune_lock", "lock_receipt", "counter_row", "campaign_manifest", "provider_receipts", "energy_receipt", "result_root", "independent_validation", "assessment_absence"}
...
def compile_protocol(repo_root: Path = ROOT) -> dict[str, Any]:
    ...
    compiled: dict[str, Any] = {
        ...
        "execution_gate": {"review_accept_required": True, "synthetic_candidate_required": True, "zero_spend_preflight_required": True, "provider_allocation_required": True, "one_bounded_job_maximum": True, "effects_run": False},
