...
State slice: `Phase 444 HSAI tiny Z3 accepted-append decision candidate review boundary`.

Phase 444 defines a docs-first boundary for future local review metadata over
one Phase 443 tiny-Z3 accepted-append decision candidate. This boundary does
not implement decision-candidate review metadata, mutate the accepted Evidence
...
The future accepted-append decision candidate review may classify one Phase 443
tiny-Z3 decision candidate for local review readiness while the real accepted
append path remains blocked. It may only review candidate digest consistency,
...
- Phase 443 candidate state is promoted or drifted;
...
HSAI can locally review one tiny-Z3 accepted-append decision candidate while
