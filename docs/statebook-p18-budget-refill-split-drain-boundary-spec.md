...
3. Harness corpus covers slow-drain aggregate exhaustion and concurrent tip
   contention where only one reservation succeeds.
...
4. Contended CAS tip: exactly one success.
