...
- `BenchmarkPackReader` file digest validation, evidence ledger validation, embedded score report validation, pack summary consistency validation, and pack metadata claim-language validation.
