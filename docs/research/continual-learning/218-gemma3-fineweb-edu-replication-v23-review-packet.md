# Gemma3 FineWeb-Edu replication V23 independent-review packet

State slice: `continual-learning-gemma3-fineweb-edu-replication-v23`.

Read exactly these seven files and no others:

1. `docs/research/continual-learning/217-gemma3-fineweb-edu-replication-v23-protocol.md`
2. `docs/research/continual-learning/218-gemma3-fineweb-edu-replication-v23-review-packet.md`
3. `experiments/continual_learning/gemma3_fineweb_edu_replication_v23_contract.py`
4. `experiments/continual_learning/prepare_gemma3_fineweb_edu_replication_v23.py`
5. `experiments/continual_learning/validate_gemma3_fineweb_edu_replication_v23.py`
6. `experiments/continual_learning/stage_and_run_gemma3_fineweb_edu_replication_v23.py`
7. `experiments/continual_learning/tests/test_gemma3_fineweb_edu_replication_v23.py`
...
Verify every extant V1–V22 artifact is exact and pinned, including V14’s
...
V23 receipt only after a valid independent `ACCEPT`.
