# Gemma3 FineWeb-Edu replication V21 independent-review packet

State slice: `continual-learning-gemma3-fineweb-edu-replication-v21`.

Read exactly these seven files and no others:

1. `docs/research/continual-learning/209-gemma3-fineweb-edu-replication-v21-protocol.md`
2. `docs/research/continual-learning/210-gemma3-fineweb-edu-replication-v21-review-packet.md`
3. `experiments/continual_learning/gemma3_fineweb_edu_replication_v21_contract.py`
4. `experiments/continual_learning/prepare_gemma3_fineweb_edu_replication_v21.py`
5. `experiments/continual_learning/validate_gemma3_fineweb_edu_replication_v21.py`
6. `experiments/continual_learning/stage_and_run_gemma3_fineweb_edu_replication_v21.py`
7. `experiments/continual_learning/tests/test_gemma3_fineweb_edu_replication_v21.py`
...
V21 receipt only after a valid independent `ACCEPT`.
