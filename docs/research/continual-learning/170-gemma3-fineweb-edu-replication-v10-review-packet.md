# Gemma3 FineWeb-Edu replication V10 independent-review packet

State slice: `continual-learning-gemma3-fineweb-edu-replication-v10`.

Read exactly these seven files and no others:

1. `docs/research/continual-learning/169-gemma3-fineweb-edu-replication-v10-protocol.md`
2. `docs/research/continual-learning/170-gemma3-fineweb-edu-replication-v10-review-packet.md`
3. `experiments/continual_learning/gemma3_fineweb_edu_replication_v10_contract.py`
4. `experiments/continual_learning/prepare_gemma3_fineweb_edu_replication_v10.py`
5. `experiments/continual_learning/validate_gemma3_fineweb_edu_replication_v10.py`
6. `experiments/continual_learning/stage_and_run_gemma3_fineweb_edu_replication_v10.py`
7. `experiments/continual_learning/tests/test_gemma3_fineweb_edu_replication_v10.py`
...
The parent creates the V10 receipt only after a valid `ACCEPT`. A rejection or
missing report is not acceptance. Do not create a V10 receipt.
