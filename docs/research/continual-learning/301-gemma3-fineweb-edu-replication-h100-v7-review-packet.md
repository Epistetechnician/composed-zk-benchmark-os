# Independent review packet — Gemma3 FineWeb-Edu H100 V7
...
from result binding, or V1/V2/V3/V4/V5/V6 scientific material can enter V7.

## Exact allowlist

1. `docs/research/continual-learning/300-gemma3-fineweb-edu-replication-h100-v7-protocol.md`
2. `docs/research/continual-learning/301-gemma3-fineweb-edu-replication-h100-v7-review-packet.md`
3. `experiments/continual_learning/gemma3_fineweb_edu_replication_h100_v7_preflight.py`
4. `experiments/continual_learning/gemma3_fineweb_edu_replication_h100_v7.py`
5. `experiments/continual_learning/validate_gemma3_fineweb_edu_replication_h100_v7.py`
6. `experiments/continual_learning/pack_gemma3_fineweb_edu_replication_h100_v7.py`
7. `experiments/continual_learning/tests/test_gemma3_fineweb_edu_replication_h100_v7_preflight.py`
8. `experiments/continual_learning/tests/test_gemma3_fineweb_edu_replication_h100_v7.py`
9. `experiments/continual_learning/gemma3_fineweb_edu_replication_h100_v7_provider/Dockerfile`
10. `experiments/continual_learning/gemma3_fineweb_edu_replication_h100_v7_provider/requirements.lock`
11. `experiments/continual_learning/gemma3_fineweb_edu_replication_h100_v7_provider/runtime-lock.json`
12. `experiments/continual_learning/gemma3_fineweb_edu_replication_h100_v7_provider/run_h100_v7.sh`
13. `AGENTS.md`
14. `docs/research/continual-learning/302-gemma3-fineweb-edu-replication-h100-v7-implementation-manifest.json`
