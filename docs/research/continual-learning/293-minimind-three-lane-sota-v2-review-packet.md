# MiniMind three-lane V2 independent review packet
...
byte invalidates the entire packet and requires a fresh V2 review.
...
rejection is terminal for this V2 identity. A passing review authorizes only
