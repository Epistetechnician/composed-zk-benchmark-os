# Gemma3 FineWeb-Edu replication V28 independent-review packet

State slice: `continual-learning-gemma3-fineweb-edu-replication-v28`.

Read exactly these seven files and no others:

1. `docs/research/continual-learning/233-gemma3-fineweb-edu-replication-v28-protocol.md`
2. `docs/research/continual-learning/234-gemma3-fineweb-edu-replication-v28-review-packet.md`
3. `experiments/continual_learning/gemma3_fineweb_edu_replication_v28_contract.py`
4. `experiments/continual_learning/prepare_gemma3_fineweb_edu_replication_v28.py`
5. `experiments/continual_learning/validate_gemma3_fineweb_edu_replication_v28.py`
6. `experiments/continual_learning/stage_and_run_gemma3_fineweb_edu_replication_v28.py`
7. `experiments/continual_learning/tests/test_gemma3_fineweb_edu_replication_v28.py`
...
descriptor-bound file and Parquet custody; the byte-identical external V28
model snapshot and snapshot-only model loading; read-only snapshot modes with
permission-safe rollback cleanup; explicit false
...
V28 receipt only after a valid independent `ACCEPT`.
