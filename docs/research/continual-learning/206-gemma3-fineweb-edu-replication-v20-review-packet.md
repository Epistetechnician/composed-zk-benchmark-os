# Gemma3 FineWeb-Edu replication V20 independent-review packet

State slice: `continual-learning-gemma3-fineweb-edu-replication-v20`.

Read exactly these seven files and no others:

1. `docs/research/continual-learning/205-gemma3-fineweb-edu-replication-v20-protocol.md`
2. `docs/research/continual-learning/206-gemma3-fineweb-edu-replication-v20-review-packet.md`
3. `experiments/continual_learning/gemma3_fineweb_edu_replication_v20_contract.py`
4. `experiments/continual_learning/prepare_gemma3_fineweb_edu_replication_v20.py`
5. `experiments/continual_learning/validate_gemma3_fineweb_edu_replication_v20.py`
6. `experiments/continual_learning/stage_and_run_gemma3_fineweb_edu_replication_v20.py`
7. `experiments/continual_learning/tests/test_gemma3_fineweb_edu_replication_v20.py`
...
V20 receipt only after a valid independent `ACCEPT`.
