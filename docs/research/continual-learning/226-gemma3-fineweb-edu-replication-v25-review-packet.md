# Gemma3 FineWeb-Edu replication V25 independent-review packet

State slice: `continual-learning-gemma3-fineweb-edu-replication-v25`.

Read exactly these seven files and no others:

1. `docs/research/continual-learning/225-gemma3-fineweb-edu-replication-v25-protocol.md`
2. `docs/research/continual-learning/226-gemma3-fineweb-edu-replication-v25-review-packet.md`
3. `experiments/continual_learning/gemma3_fineweb_edu_replication_v25_contract.py`
4. `experiments/continual_learning/prepare_gemma3_fineweb_edu_replication_v25.py`
5. `experiments/continual_learning/validate_gemma3_fineweb_edu_replication_v25.py`
6. `experiments/continual_learning/stage_and_run_gemma3_fineweb_edu_replication_v25.py`
7. `experiments/continual_learning/tests/test_gemma3_fineweb_edu_replication_v25.py`
...
Verify every extant V1–V24 artifact is exact and pinned, including V14’s
...
descriptor-bound file and Parquet custody; the byte-identical external V25
...
V25 receipt only after a valid independent `ACCEPT`.
