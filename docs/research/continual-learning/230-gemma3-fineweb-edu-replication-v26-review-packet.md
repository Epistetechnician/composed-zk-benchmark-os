# Gemma3 FineWeb-Edu replication V26 independent-review packet

State slice: `continual-learning-gemma3-fineweb-edu-replication-v26`.

Read exactly these seven files and no others:

1. `docs/research/continual-learning/225-gemma3-fineweb-edu-replication-v26-protocol.md`
2. `docs/research/continual-learning/226-gemma3-fineweb-edu-replication-v26-review-packet.md`
3. `experiments/continual_learning/gemma3_fineweb_edu_replication_v26_contract.py`
4. `experiments/continual_learning/prepare_gemma3_fineweb_edu_replication_v26.py`
5. `experiments/continual_learning/validate_gemma3_fineweb_edu_replication_v26.py`
6. `experiments/continual_learning/stage_and_run_gemma3_fineweb_edu_replication_v26.py`
7. `experiments/continual_learning/tests/test_gemma3_fineweb_edu_replication_v26.py`
...
descriptor-bound file and Parquet custody; the byte-identical external V26
...
V26 receipt only after a valid independent `ACCEPT`.
