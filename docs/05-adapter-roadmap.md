...
| Future Phase J | Reviewed proposal acceptance policy | Define review decisions, blocking issues, supersession, and future append eligibility without live external execution. | Proposal policy tests and ledger transition tests. |
