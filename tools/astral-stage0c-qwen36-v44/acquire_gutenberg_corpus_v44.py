#!/usr/bin/env python3
"""Acquire and atomically seal the fresh V44 Gutenberg corpus.
...
END_MARKER = b"*** END OF"
USER_AGENT = "Astral-V44-corpus-custody/1.0"
...
def acquire(output_root: Path, repository_root: Path) -> Path:
    ...
    try:
        ...
        protocol.write_json(staging / "corpus-manifest.json", {
            "protocol": protocol.PROTOCOL_ID,
            "state_slice": protocol.STATE_SLICE,
            "corpus_kind": "project-gutenberg-canonical-text-rdf-v44",
            "selection_sha256": protocol.selection_digest(),
