...
def validate_run(aggregate: dict[str, Any], manifest: dict[str, Any], *, custody_root: Path, repository_root: Path) -> dict[str, Any]:
    result = _legacy_validate.validate_run(aggregate, manifest, custody_root=custody_root, repository_root=repository_root)
