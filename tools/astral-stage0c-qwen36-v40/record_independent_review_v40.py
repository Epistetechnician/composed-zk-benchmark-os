#!/usr/bin/env python3
"""Record an explicit independent-review attestation for V40.

State slice: astral-stage0c-qwen36-intervention-conditioned-target-v40.

The caller must supply the reviewer identity and attestation. This command
refuses to create an acceptance from defaults and does not run assessment.
"""
