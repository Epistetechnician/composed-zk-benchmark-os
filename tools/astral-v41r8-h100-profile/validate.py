...
EXPECTED_VERSION = "mesh.astral_v41r8_h100_runtime_profile.v1"
EXPECTED_SLICE = "V41R8NativeMXFP4AttentionLoRACorrection"
EXPECTED_MODEL = "openai/gpt-oss-20b"
EXPECTED_REVISION = "d0e2aa76789354d715f8b22553b9feb6c462fcf0"
EXPECTED_CEILING = "RemoteH100RuntimeProfileOnlyV41R8"
...
def validate_inventory(inventory: Any) -> list[str]:
    ...
    if not isinstance(names, list) or len(names) != 288 or len(set(names)) != 288:
...
def validate(artifact: Path, rgs_root: Path) -> dict[str, Any]:
    ...
    if not isinstance(commit, str) or len(commit) != 40:
        ...
        for key, relative in (
            ("runner_sha256", "scripts/run_v41r8_h100_profile.py"),
            ...
            ("attention_contract_sha256", "mesh_brain/meshmodel/v41r8_attention_lora.py"),
    ...
    return {
        "version": "astral.v41r8_h100_profile_validation.v1",
        "valid": not errors,
