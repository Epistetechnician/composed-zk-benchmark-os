...
H=Path(__file__).resolve().parent;S=importlib.util.spec_from_file_location("v34v",H/"v34.py");assert S and S.loader;M=importlib.util.module_from_spec(S);sys.modules[S.name]=M;S.loader.exec_module(M)
def main(argv=None):
