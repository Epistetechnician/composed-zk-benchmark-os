...
pub use audit_index::{
    ...
    compute_local_audit_index_manifest_digest, deserialize_local_audit_index_ergonomics_view_json,
    deserialize_local_audit_index_manifest_json, read_local_audit_index_ergonomics_outputs,
    ...
    validate_local_audit_index_ergonomics_request, validate_local_audit_index_manifest,
